...
float model_ss_ (0.004f); //amostragem do modelo em milimetros
float scene_ss_ (0.004f); //amostragem da cena em milimetros
...
float Lim_dist_ (200000000.0f); //Distancia minima entre descritores para que se considere válida a correspondencia
