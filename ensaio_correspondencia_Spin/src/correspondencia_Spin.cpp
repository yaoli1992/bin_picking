...
float norm_rad_ (4.0f);

float rf_rad_ (0.05f);
float descr_rad_ (0.04f);

float cg_size_ (0.09f);
...
*/
  ...
  //
  //  Compute Descriptor for keypoints Spin images
  //
        ...
        descr_est.setRadiusSearch(1.00);
...
std::cout << rototranslations.size () << std::endl; //debug
  for (size_t i = 0; i < rototranslations.size (); i=+10)
  {
